...
Kr1bou::Kr1bou() {
    motor_right = new Motor(M2_PIN_CW, M2_PIN_CCW, SPI_CS_1_PIN, false, 0.045*PI);
    motor_right->setKpKiKd(10,0,0); //300,600,0
    motor_right->setPwmOffset(60);
    motor_right->setSpeed(0);

    motor_left = new Motor(M1_PIN_CW, M1_PIN_CCW, SPI_CS_0_PIN, true, 0.045*PI);
    motor_left->setKpKiKd(10,0,0); //300,600,0
    motor_left->setPwmOffset(60);
