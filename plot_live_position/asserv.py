...
############################### NODE ROS : path_controle_node ###############################
# Ce noeud ROS permet de controler les moteurs du robot pour suivre un chemin
# Il recoit les objectifs de position et d'angle a atteindre et calcule les vitesses des moteurs
#----------------------> Il ecoute les topics 'next_objectif', 'max_speed' et 'stop' <-----------------------
# ---------------------> Il publie les vitesses des moteurs sur le topic 'motor_speed' <---------------------
...
class kr1bou():
    def __init__(self):
        ...
        self.freq = 10 # Hz a definir avec un parametre rosparam

        rospy.init_node('path_controle_node', anonymous=True)
